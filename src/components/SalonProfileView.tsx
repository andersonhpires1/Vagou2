...
export const SalonProfileView: React.FC<SalonProfileViewProps> = ({
  ...
  const handleUpdateSettings = (newSettings: Partial<SalonAdminSettings>) => {
    setAdminSettings((prev) => {
      ...
      try {
        ...
        updateDynamicPwaAssets(effectiveName, merged.salonIcon);
      } catch {
        // ignore
      }
      return merged;
  ...
  useEffect(() => {
    ...
    updateDynamicPwaAssets(effectiveName, adminSettings.salonIcon);
  }, [adminSettings.pwaName, adminSettings.salonName, adminSettings.salonIcon, salonName]);
