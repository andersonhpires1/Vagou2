...
const DEFAULT_SUPPLIES: SupplyItem[] = [
  {
    id: 'sup-1',
    name: 'Pó Descolorante Platinum',
    category: 'quimica',
    currentStock: 450,
    unit: 'g',
    consumptionPerService: 50,
    serviceName: 'Mechas & Iluminação de Fios',
    minAlertThreshold: 150,
  },
  {
    id: 'sup-2',
    name: 'Oxidante 30 Volumes (Emulsão)',
    category: 'quimica',
    currentStock: 900,
    unit: 'ml',
    consumptionPerService: 90,
    serviceName: 'Mechas & Iluminação de Fios',
    minAlertThreshold: 250,
  },
  {
    id: 'sup-3',
    name: 'Lâminas Descartáveis Platinum',
    category: 'barbearia',
    currentStock: 14,
    unit: 'un',
    consumptionPerService: 1,
    serviceName: 'Barba Terapia Premium',
    minAlertThreshold: 10,
  },
  {
    id: 'sup-4',
    name: 'Toalhas Quentes Esterilizadas',
    category: 'higiene',
    currentStock: 18,
    unit: 'un',
    consumptionPerService: 2,
    serviceName: 'Barba Terapia Premium',
    minAlertThreshold: 8,
  },
  {
  ...
  },
  {
    ...
    currentStock: 320,
    unit: 'ml',
    consumptionPerService: 30,
    serviceName: 'Lavagem & Hidratação Especial',
