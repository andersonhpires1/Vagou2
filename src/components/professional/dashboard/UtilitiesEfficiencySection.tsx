...
const DEFAULT_APPLIANCES: UtilityAppliance[] = [
  { id: 'app-1', name: 'Secador Profissional Taiff', powerWatts: 2400, category: 'energia', dailyHoursOrUsages: 3.5 },
  { id: 'app-2', name: 'Ar-Condicionado Split 12.000 BTUs', powerWatts: 1800, category: 'energia', dailyHoursOrUsages: 8.0 },
  { id: 'app-3', name: 'Frigobar / Cervejeira de Bebidas', powerWatts: 120, category: 'energia', dailyHoursOrUsages: 24.0 },
  { id: 'app-4', name: 'Prancha & Modelador Babyliss', powerWatts: 65, category: 'energia', dailyHoursOrUsages: 2.0 },
  { id: 'app-5', name: 'Máquina de Corte & Acabamento (Carga)', powerWatts: 25, category: 'energia', dailyHoursOrUsages: 4.0 },
  { id: 'app-6', name: 'Lavatório de Cabelo (Ducha & Descarga)', powerWatts: 0, category: 'agua', dailyHoursOrUsages: 18.0 } // 18 litros por atendimento
];
