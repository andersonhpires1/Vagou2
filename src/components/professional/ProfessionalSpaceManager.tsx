...
export const ProfessionalSpaceManager: React.FC<ProfessionalSpaceManagerProps> = ({
  ...
  const [salonPhone, setSalonPhone] = useState(adminSettings.salonPhone || '(41) 99882-1140');
  ...
  // Processamento de Upload do Logo Retangular
  ...
  // Processamento de Upload do Ícone Quadrado (PWA)
