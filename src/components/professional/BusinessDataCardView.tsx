...
export const BusinessDataCardView: React.FC<BusinessDataCardViewProps> = ({
  ...
  // 4. Responsável Legal
  const [legalManagerName, setLegalManagerName] = useState(adminSettings.legalManagerName || 'Anderson Pires');
  const [legalManagerCpf, setLegalManagerCpf] = useState(adminSettings.legalManagerCpf || '');
  const [legalManagerPhone, setLegalManagerPhone] = useState(adminSettings.legalManagerPhone || adminSettings.salonPhone || '(41) 99882-1140');
  const [legalManagerEmail, setLegalManagerEmail] = useState(adminSettings.legalManagerEmail || 'anderson.hpires@gmail.com');
  ...
  const handleSave = (e?: React.FormEvent) => {
    ...
    onUpdateSettings({
      salonName: salonName.trim() || 'Barbearia Rota 99',
        ...
        <div className={`p-3.5 rounded border space-y-3 ${
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ex: Barbearia Rota 99"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="Ex: Rota 99 Serviços de Beleza LTDA"
